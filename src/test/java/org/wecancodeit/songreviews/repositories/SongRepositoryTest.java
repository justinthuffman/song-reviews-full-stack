...
//		// Arrange
//		Category test = new Category("Test", "test.jpg");
//		Song song = new Song("Song1", "artist1,", "album1", "Album image1", test, "release date1", "content1", "uri1");
//		// Act
...
//		Song song = new Song("Song2", "artist2,", "album2", "Album image2", C, "release date2", "content2", "uri2");
//
//		songRepo.add(song);
